...
Baixar um projeto e instalar suas dependências;
Iniciar um servidor local para visualizar as alterações do projeto em tempo real;
Estilizar componentes com a biblioteca styled-component;
Construir componentes;
Criar interfaces para determinar o tipo de dado que está sendo enviado para os componentes.